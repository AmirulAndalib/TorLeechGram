...
from .database_handle import TorLeechGramDB
from .. import user_db
...
tordb = TorLeechGramDB()
header =  '<b>**TorLeechGram** by <a href="https://github.com/priiiyo">Priiiyo</a></b>\n<u>USER SETTINGS MENU - v1.1</u>'
...
async def handle_user_settings(e,edit=False,msg="",submenu=None,sender_id=None):
    ...
    if submenu is None:
        ...
        if edit:
            rmess = await e.edit(header+"\nEnjoiii.\n"+msg,parse_mode="html",buttons=menu,link_preview=False, file="leechgram.jpg")
        else:
            rmess = await e.reply(header+"\nEnjoiii.\n",parse_mode="html",buttons=menu,link_preview=False, file="leechgram.jpg")
