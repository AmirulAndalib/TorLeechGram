...
from .database_handle import TlgUpload,TlgTorrents, TorLeechGramDB
...
from torleechgram import __version__
from .tlg_ytdl import handle_ytdl_command,handle_ytdl_callbacks,handle_ytdl_file_download,handle_ytdl_playlist,handle_ytdl_playlist_down
...
async def start_handler(event):
    msg = "Hello This is TorToolkit an instance of <a href='https://github.com/priiiyo/TorLeechGram'>This Repo</a>. Try the repo for yourself and dont forget to put a STAR and fork."
...
async def about_me(message):
    ...
    msg = (
        "<b>Name</b>: <code>TorLeechGram</code>\n"
        f"<b>Version</b>: <code>{__version__}</code>\n"
        f"<b>Telethon Version</b>: {telever}\n"
        f"<b>Pyrogram Version</b>: {pyrover}\n"
        "<b>Created By</b>: @priiiyo\n\n"
